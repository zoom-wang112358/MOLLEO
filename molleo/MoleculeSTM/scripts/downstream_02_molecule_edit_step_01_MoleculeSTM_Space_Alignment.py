...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataspace_path", type=str, default="/scratch/ssd004/scratch/mskrt/datasets/")
    ...
    ########## for MoleculeSTM ##########
    parser.add_argument("--MoleculeSTM_model_dir", type=str, 
            default="/scratch/ssd004/scratch/mskrt/huggingface_models/MoleculeSTM/demo/demo_checkpoints_SMILES")
